...
def task_done_pick(
    ...
    """Determine if the object pick task is complete.

    This function checks whether all success conditions for the task have been met:
    1. object is highter than a minimum height
    2. object velocity is below threshold

    Args:
        env: The RL environment instance.
        object_cfg: Configuration for the object entity.
        min_height: Minimum height of the object for task completion.
    ...
    object_origin_height = object.data.default_root_state[:, 2] # or use table height
    object_vel = torch.abs(object.data.root_vel_w)

    # Check all success conditions and combine with logical AND
    done = object_height - object_origin_height > min_height
    # print("object height:", object_height - object_origin_height)
