...
All the environments are registered in the `isaac_g1_factory_demo` extension. They start
...
import isaac_g1_factory_demo.tasks  # noqa: F401


def main():
    """Print all environments registered in `isaac_g1_factory_demo` extension."""
